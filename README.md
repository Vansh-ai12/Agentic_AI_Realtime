...
<!-- PASTE a real trace/output here — either a fenced code block of terminal/JSON output, or a screenshot via GitHub's drag-and-drop image upload -->

```
<!-- PASTE your test_graph_pipeline.py output here, e.g.:
